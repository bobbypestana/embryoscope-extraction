...
def run():
    # Fetch a month that definitely has many records, e.g. 2024-01-01 to 2024-01-31
    r = requests.get(f"{BASE}/rest/CONSNOTA/notas", params={"dataIni": "20240101", "dataFim": "20240131", "nPage": 1, "nPageSize": 5}, headers=HEADERS, auth=AUTH)
