...
COLUMN_MAPPING = OrderedDict([
    ...
    ("Embryo Description Clinisys", "oocito_ResultadoPGD"),
    ("Embryo Description Clinisys Detalhes", "oocito_ResultadoPGDDetalhes"),
    ...
    ("redlara_source_sheet", "redlara_source_sheet"),
