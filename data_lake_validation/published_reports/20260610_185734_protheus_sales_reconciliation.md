...
> * **Local Key Overlap Rate**: **0.000%**
> * **Target Key Overlap Rate**: **0.000%**
...
* **Total Overlapping Keys**: **0**
* **Keys ONLY in Local**: **523,248**
* **Keys ONLY in Target**: **581,601**

### 3.1 Overlap Value Comparison
| Column Name | Local Sum | Target Sum | Difference | Alignment Rate |
| :--- | :---: | :---: | :---: | :---: |
| **total** | 0.00 | 0.00 | +0.00 | 100.0000% |

---

## 4. Key Takeaways & Root Cause Analysis

### 4.1 Sample Records Only in Local (523,248 total)
...
### 4.2 Sample Records Only in Target (581,601 total)
| Loja | Numero | Serie Docto. | Dt Emissao | Total |
| :---: | :---: | :---: | :---: | :---: |
