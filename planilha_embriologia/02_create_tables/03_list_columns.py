#!/usr/bin/env python3
"""
Helper script to list all columns in gold.planilha_embryoscope_combined
This helps identify the exact column names for mapping.
"""
...
# We'll duplicate the function here to avoid import issues
...
def list_all_columns():
    """List all columns in the combined table"""
    ...
    try:
        ...
        # Search for columns matching target names
        print("\n\n" + "=" * 80)
        print("SEARCHING FOR COLUMNS MATCHING TARGET NAMES")
        print("=" * 80)
