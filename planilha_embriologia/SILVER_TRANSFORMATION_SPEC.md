...
flowchart TD
    ...
    subgraph SILVER["Silver Layer (Consolidated Output)"]
        S_FRESH["silver.planilha_embriologia_fresh"]
        S_FET["silver.planilha_embriologia_fet"]
        S_RECEP["silver.planilha_embriologia_recep"]
        S_FOT["silver.planilha_embriologia_fot"]
        S_DOADORAS["silver.planilha_embriologia_doadoras"]
        S_FP_OV["silver.planilha_embriologia_fp_ovulos"]
        S_FP_SEM["silver.planilha_embriologia_fp_semen"]
        S_IIU["silver.planilha_embriologia_iiu"]
    end
...
All tables in schema `bronze` matching `planilha_%` across target cohorts (`2021`–`2026`) are routed to the 8 target streams based on naming patterns:
...
if sheet_type == 'fresh':
    ...
    condition = f"(table_name LIKE '%_doadoras' OR {shared_condition})"
    ...
    condition = f"(table_name LIKE '%_fp_cong_de_semen%' OR table_name LIKE '%_semen%')"
elif sheet_type == 'iiu':
...
- `silver.planilha_embriologia_doadoras`: High-confidence donor matching
- `silver.planilha_embriologia_fp_ovulos`: High-confidence female preservation matching
- `silver.planilha_embriologia_fp_semen`: High-confidence male preservation matching
- `silver.planilha_embriologia_iiu`: High-confidence insemination matching
