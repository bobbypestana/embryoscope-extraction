...
# Add parent directory to path for imports (only needed for utils now)
parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.insert(0, parent_dir)

# Import helper modules from current directory (now local)
...
# Load log level from params.yml in parent directory
...
def main():
    ...
    # Process all embryoscope databases in the root database folder
