...
parent_dir = script_dir.parent  # Parent embryoscope directory
project_root = parent_dir  # Use parent directory since params.yml is there
...
LOGS_DIR = parent_dir / 'logs'  # logs in parent embryoscope directory
