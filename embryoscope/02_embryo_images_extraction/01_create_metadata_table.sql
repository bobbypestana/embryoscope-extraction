...
-- IMPORTANT: Comment out this line in production to preserve existing data
-- DROP TABLE IF EXISTS gold.embryo_images_metadata;

-- Create the metadata table
CREATE TABLE IF NOT EXISTS gold.embryo_images_metadata (
    embryo_id VARCHAR PRIMARY KEY,                    -- Embryo ID (same as Slide ID from data_ploidia)
    ...
    embryo_folder_path VARCHAR,                        -- Path to embryo folder (contains images.zip and imageruns.json)
